...
video::https://videos.learning.redhat.com/media/hcp-on-bm-intro/1_79vnk220[title="Introduction segment from the Red Hat One 2025 session – Maximizing ROI with Hosted Control Planes: Strategies for Scalable Environments"]
