...
WARNING: If you have issues watching the video embedded in this page, watch it directly on the https://videos.learning.redhat.com/media/hcp-on-bm-intro/1_8pyq0hy3[Red Hat media space^], which requires the Red Hat VPN and an employee log in.
