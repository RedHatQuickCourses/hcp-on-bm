...
.. If your playbook fails close to its end, you may have a healthy cluster and follow its soure code to complete tasks manually, for example:
+
...
+
NOTE: Most times, there would be no need to destroying your AWS open environment and recreating it from scratch.
+
