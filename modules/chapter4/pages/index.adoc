...
_Watch the https://videos.learning.redhat.com/media/hcp-on-bm-add-hosts/1_zr4kmp6f[video^] and then follow the instructions in this section to perform the lab._
