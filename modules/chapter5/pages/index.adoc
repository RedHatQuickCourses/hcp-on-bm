...
_Watch the following https://videos.learning.redhat.com/media/hcp-on-bm-hosted-cluster/1_ufciaghw[video^] and then follow the instructions in this section to perform the lab._
