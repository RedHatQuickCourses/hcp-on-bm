...
_Watch the https://videos.learning.redhat.com/media/hcp-on-bm-add-hosts-bmc/1_gyapthnx[video^] and then follow the instructions in this section to perform the lab._
